import { Profiler, useState, useMemo, useCallback, type ProfilerOnRenderCallback } from 'react';
...
export const App = () => {
  ...
  const handleProfileRender: ProfilerOnRenderCallback = (
    ...
    const metric: ProfileMetric = {
      id,
      phase,
      renderDuration: Number(actualDuration.toFixed(2)),
      commitDuration: Number(Math.max(0, commitTime - startTime).toFixed(2)),
  ...
  return (
    <Profiler id="app-root" onRender={handleProfileRender}>
